...
export function LogoReveal() {
  return (
    <div className="logo-reveal">
      <div className="logo-reveal-wordmark">
        <svg
          viewBox="0 0 750 180"
          fill="none"
      ...
      <div className="logo-reveal-scrim">
        <div />
      </div>
      <svg
        className="logo-reveal-logomark"
        viewBox="0 0 200 199"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_2254_253)">
          <g clipPath="url(#clip1_2254_253)">
            <g className="logo-reveal-spin">
              <rect
                x="107.469"
                y="199.301"
                width="14.5784"
