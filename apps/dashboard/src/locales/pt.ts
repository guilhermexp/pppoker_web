export default {
  ...
  sidebar: {
    ...
    poker_jogadores: "Jogadores",
    poker_agentes: "Agentes",
    poker_super_agentes: "Super Agentes",
    poker_lobby: "Lobby",
  ...
  poker: {
    ...
    jogadores: {
      title: "Jogadores",
      description: "Jogadores do clube com dados ao vivo",
    },
    agentes: {
      title: "Agentes",
      description: "Agentes do clube e seus jogadores vinculados",
    },
    super_agentes: {
      title: "Super Agentes",
      description: "Super agentes e hierarquia do clube",
    },
    lobby: {
      title: "Lobby",
  ...
  fastchips: {
    ...
    payment_orders: {
      stats: {
        links_gerados: "Links Pendentes",
        pagos: "Pagos (aguardando fichas)",
        fichas_enviadas_hoje: "Concluidos Hoje",
        total_vendido_hoje: "Total Vendido Hoje",
      },
      search_placeholder: "Buscar jogador ou NSU...",
      filter_all: "Todos",
      status: {
      ...
      actions: {
        copiar_link: "Copiar link de pagamento",
        marcar_enviadas: "Marcar fichas enviadas",
      },
      empty: "Nenhum pedido de pagamento encontrado",
      total_pedidos: "{count} pedido(s) no total",
    },
    transacoes: {
      title: "Transacoes",
      description: "Visualize e gerencie todas as transacoes de Fast Chips",
      refresh: "Atualizar",
      view_by: "Visualizar transacoes por:",
      entries: "Entradas",
      exits: "Saidas",
      search_placeholder: "Buscar...",
      filter_all: "Todos",
      filter_completed: "Efetuado",
      filter_unpaid: "Nao pago",
      status_completed: "Efetuado",
      status_unpaid: "Nao pago",
      details_title: "Informacoes da transacao",
      player_data: "Dados do jogador",
      purchase_data: "Dados da compra",
      view_movements: "Ver movimentacao",
      table: {
        name: "Nome",
    ...
    contas_vinculadas: {
      ...
      refresh: "Atualizar",
      stats: {
        inactive_blocked: "Inativo / Bloqueado",
        active_blocked_withdraw: "Ativo / Saque bloqueado",
        total_players: "Total de jogadores",
      },
      view_by: "Visualizar informacoes dos jogadores por:",
      view_all: "Todos",
      view_custom: "Personalizados",
      search_placeholder: "Buscar...",
      filter_all: "Todos",
      filter_active: "Ativo",
      ...
      restriction_auto_withdraw: "Saque automatico",
      restriction_blocked: "Saque bloqueado",
      actions: {
        reset_withdraw: "Resetar saques",
        block_withdraw: "Bloquear saque",
        block_account: "Bloquear conta",
        manual_withdraw: "Saque manual",
        customize_withdraw: "Personalizar saques",
      },
      table: {
        name: "Nome",
        player_id: "Jogador ID",
      ...
      details_title: "Informacoes do jogador",
      player_data: "Dados do jogador",
    ...
    jogadores: {
      ...
      refresh: "Atualizar",
      total_players: "Total de Jogadores",
      no_new_players: "Voce nao ganhou nenhum jogador nos ultimos 30 dias",
      search_placeholder: "Buscar...",
      table: {
        name: "Nome",
        linked_at: "Vinculo",
      ...
      "linked_accounts#one": "{count} conta vinculada",
      "linked_accounts#other": "{count} contas vinculadas",
      linked_accounts_title: "Contas vinculadas de",
      player_id: "ID: ",
      sheet_table: {
        name: "Nome",
        status: "Status",
    ...
    movimentacao: {
      ...
      add: "Adicionar",
      withdraw: "Efetuar Resgate",
      view_by: "Visualizar movimentacoes por:",
      operations: "Operacoes",
      withdraw_data: "Dados para resgate",
      export: "Exportar",
      range_last_month: "01/01/2025 - 31/01/2025",
      range_this_month: "01/02/2025 - 29/02/2025",
      range_last_7: "Ultimos 7 dias",
      total_entries: "Total de entradas",
      total_exits: "Total de saidas",
      type_entry: "Entrada",
      type_exit: "Saida",
      status_completed: "Concluido",
      status_pending: "Pendente",
      details_title: "Operacao {date} as {time}",
      payment_id: "pgto ID: ",
      operation_data: "Dados da operacao",
      view_transaction: "Ver transacao",
      table: {
    ...
    service: {
      ...
      gateway_timeout: "Tempo esgotado. O QR code expirou. Tente novamente.",
      gateway_retry: "Tentar novamente",
    ...
    controle: {
      ...
      refresh: "Atualizar",
      players_title: "Controle dos jogadores",
      players_description:
        "Personalize os valores minimos de compra/saque e a quantidade de saques que seus jogadores poderao realizar diariamente. Alem disso, voce pode habilitar/desabilitar o recebimento de mensagens de notificacoes de saque.",
      min_purchase: "Valor minimo de compra",
      min_withdraw: "Valor minimo de saque",
      daily_limit: "Limite de saques diario",
      notifications: "Mensagens de notificacoes dos saques",
      notifications_enabled: "Ativado",
      withdraw_title: "Tipos de saques",
      withdraw_description:
        "Defina o tipo de saque: Saque automatico ou Saque manual para realizar o pagamento das solicitacoes dos seus jogadores.",
      withdraw_type: "Tipo de saque",
      withdraw_auto: "Saque automatico",
      withdraw_manual: "Saque manual",
      max_value: "Valor maximo",
      withdraw_notice:
        "Se uma solicitacao de saque exceder o Valor maximo estipulado para o Saque automatico, essa solicitacao devera ser feita manualmente.",
      league_title: "ID da liga",
      league_description: "Numero de ID da liga do clube",
  ...
  approval: {
    ...
    approved: "Aprovado",
    rejected: "Rejeitado",
    action_enviar_fichas: "Enviar Fichas",
    action_sacar_fichas: "Sacar Fichas",
    action_gerar_link_pagamento: "Gerar Link de Pagamento",
    action_aprovar_solicitacao: "Aprovar Solicitacao",
    action_rejeitar_solicitacao: "Rejeitar Solicitacao",
    action_promover_membro: "Promover Membro",
    action_remover_membro: "Remover Membro",
    param_target_id: "UID do Jogador",
    param_amount: "Quantidade de Fichas",
    param_valor_reais: "Valor (R$)",
    param_fichas: "Fichas",
    param_player_uid: "UID do Jogador",
    param_player_nome: "Nome do Jogador",
    param_descricao: "Descricao",
    param_clube_id: "ID do Clube",
    param_liga_id: "ID da Liga",
    param_member_id: "ID do Membro",
  },
} as const;
