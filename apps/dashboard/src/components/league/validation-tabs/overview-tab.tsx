              ...
              {partidasStats.totalGanhos !== geralPPSTTotals.ganhosJogador && (
                <div className="flex justify-between text-xs text-muted-foreground border-t pt-1 mt-1">
                  ...
                  <span
                    className={
                      Math.abs(
                        partidasStats.totalGanhos -
                          geralPPSTTotals.ganhosJogador,
                      ) > 1
                        ? "text-amber-500"
                        : "text-green-500"
                    }
