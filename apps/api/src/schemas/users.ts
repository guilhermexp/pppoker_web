...
export const updateUserSchema = z.object({
  ...
  avatarUrl: z
    .string()
    .url()
    .refine((url) => url.includes("mid.poker"), {
      message: "avatarUrl must be a mid.poker domain URL",
    })
    .optional()
    .openapi({
      description:
        "URL to the user's avatar image. Must be hosted on mid.poker domain",
      example: "https://cdn.mid.poker/avatars/jane-doe.jpg",
    }),
  ...
  team: z
    .object({
      ...
      logoUrl: z.string().url().openapi({
        ...
        example: "https://cdn.mid.poker/logos/acme-corp.png",
      }),
