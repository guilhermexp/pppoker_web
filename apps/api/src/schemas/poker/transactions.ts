...
export const getPokerTransactionsSchema = z.object({
  ...
  type: pokerTransactionTypeSchema
    .nullable()
    .optional()
    .openapi({
...
export type GetPokerTransactionsInput = z.infer<typeof getPokerTransactionsSchema>;
export type GetPokerTransactionByIdInput = z.infer<typeof getPokerTransactionByIdSchema>;
export type DeletePokerTransactionInput = z.infer<typeof deletePokerTransactionSchema>;
