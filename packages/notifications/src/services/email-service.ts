...
import { shouldSendNotification } from "@midpoker/db/queries";
import InvoiceEmail from "@midpoker/email/emails/invoice";
import InvoiceOverdueEmail from "@midpoker/email/emails/invoice-overdue";
import InvoicePaidEmail from "@midpoker/email/emails/invoice-paid";
import InvoiceReminderEmail from "@midpoker/email/emails/invoice-reminder";
...
export class EmailService {
  ...
  #buildEmailPayload(email: EmailInput): CreateEmailOptions {
    ...
    const payload: CreateEmailOptions = {
      from: email.from || "Mid Poker <noreply@mid.poker>",
      to: recipients,
