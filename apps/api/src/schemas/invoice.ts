...
export const invoiceResponseSchema = z
  .object({
    ...
    pdfUrl: z.string().url().nullable().openapi({
      ...
      example:
        "https://app.mid.poker/api/download/invoice?token=eef58951-1682-4062-b010-425866032390",
    }),
    previewUrl: z.string().url().nullable().openapi({
      description:
        "URL to preview the invoice in the browser, or null if not generated",
      example: "https://app.mid.poker/i/eef58951-1682-4062-b010-425866032390",
    }),
  })
  .openapi({
