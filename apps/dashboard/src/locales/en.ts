export default {
  ...
  fastchips: {
    ...
    payment_orders: {
      stats: {
        links_gerados: "Pending Links",
        pagos: "Paid (awaiting chips)",
        fichas_enviadas_hoje: "Completed Today",
        total_vendido_hoje: "Total Sold Today",
      },
      search_placeholder: "Search player or NSU...",
      filter_all: "All",
      status: {
        link_gerado: "Link Generated",
        pago: "Paid",
        fichas_enviadas: "Chips Sent",
        cancelado: "Cancelled",
        erro: "Error",
      },
      table: {
      ...
      actions: {
        copiar_link: "Copy payment link",
        marcar_enviadas: "Mark chips sent",
      },
      empty: "No payment orders found",
      total_pedidos: "{count} order(s) total",
    },
    transacoes: {
      title: "Transactions",
  ...
  approval: {
    ...
    approved: "Approved",
    rejected: "Rejected",
    action_enviar_fichas: "Send Chips",
    action_sacar_fichas: "Withdraw Chips",
    action_gerar_link_pagamento: "Generate Payment Link",
    action_aprovar_solicitacao: "Approve Request",
    action_rejeitar_solicitacao: "Reject Request",
    action_promover_membro: "Promote Member",
    action_remover_membro: "Remove Member",
    param_target_id: "Player UID",
    param_amount: "Chip Amount",
    param_valor_reais: "Value (R$)",
    param_fichas: "Chips",
    param_player_uid: "Player UID",
    param_player_nome: "Player Name",
    param_descricao: "Description",
    param_clube_id: "Club ID",
    param_liga_id: "League ID",
    param_member_id: "Member ID",
  },
} as const;
